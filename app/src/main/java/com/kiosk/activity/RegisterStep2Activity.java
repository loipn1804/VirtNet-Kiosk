 ...
 */
public class RegisterStep2Activity extends BaseActivity implements View.OnClickListener, CameraSurfaceView.CameraSurfaceCallback {
    ...
    private String FILE_NAME = "reg_2.jpg";
    ...
    public void saveImageSuccess(String filename) {
        Intent intentReg3 = new Intent(this, RegisterStep3Activity.class);
