...
public class CategoryAdapter extends BaseAdapter {
    ...
    public interface OnClickOnItemCallback {
        void onCLickItem(String name, Long category_id);
    }
    ...
    public CategoryAdapter(Activity activity, List<Category> listData, OnClickOnItemCallback onClickOnItemCallback) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.txtSpinner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onClickOnItemCallback.onCLickItem(listData.get(position).getName(), listData.get(position).getCategory_id());
            }
        });
